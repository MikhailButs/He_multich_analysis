...
def create_cuts_new(path, channel):  # РЎРѕР·РґР°РЅРёРµ РјР°С‚СЂРёС†С‹ РёРЅС‚РµРЅСЃРёРІРЅРѕСЃС‚Рё РґР»СЏ РёР·РѕР±СЂР°Р¶РµРЅРёСЏ РЅР° СѓРєР°Р·Р°РЅРЅРѕР№ Р»РёРЅРёРё
...
[a, b, c] = find_channel_edge_points(I1, I2, I3, False)
im1_728 = create_cuts_moving(path_discharge_image, [top1 + a[0], left1 + a[1]], 728)
...
# РЎР»РµРґСѓСЋС‰РёР№ РєСѓСЃРѕРє РєРѕРґР° СЃРѕР·РґР°СЃС‚ РїРµСЂРµС‡РµРЅСЊ РІСЃРµС… РєР°РґСЂРѕРІ СЂР°Р·СЂСЏРґР°, РїРѕ РєРѕС‚РѕСЂРѕРјСѓ РґР°Р»РµРµ РјРѕР¶РЅРѕ Р±СѓРґРµС‚ РїСЂРѕР№С‚РёСЃСЊ РѕР±С‹С‡РЅС‹Рј С†РёРєР»РѕРј for
# path_discharge_folder = r'E:\PhD_study\He_monitor\He_image_processing' + '\\' + str(discharge)
# file_list = os.listdir(path_discharge_folder)
# image_list = []
# file_format = '.jpg'
# for image in file_list:
#     if fnmatch.fnmatch(image, 'Img*.' + file_format):
#         image_list.append(image)
# print(image_list[0])
# print(len(image_list))
# sum_sub1 = []  # СЃРѕР·РґР°РЅРёРµ РїСѓСЃС‚РѕРіРѕ СЃРїРёСЃРєР° РґР»СЏ РґР°Р»СЊРЅРµР№С€РµРіРѕ РµРіРѕ Р·Р°РїРѕР»РЅРµРЅРёСЏ РЅР° РєР°Р¶РґРѕРј РєР°РґСЂРµ
# for i in range(5):  # range(len(image_list)):
#     image_path = path_discharge_folder + '\\' + image_list[i]
#     print(image_path)
#     im = np.array(Image.open(image_path))
#     sub_im1 = im[40:80, 100:120]  # СЃРѕР·РґР°РЅРёРµ РїРѕРґРјР°С‚СЂРёС†С‹
#     sum_sub1.append(np.sum(sub_im1))  # СЃСѓРјРјРёСЂРѕРІР°РЅРёРµ РёРЅС‚РµРЅСЃРёРІРЅРѕСЃС‚РµР№ РІСЃРµРіРѕ РёР·РѕР±СЂР°Р¶РµРЅРёСЏ
# print(sum_sub1)